...
class _HostsPageState extends State<HostsPage> {
                  ...
                  child: ListenableBuilder(
                    ...
                    builder: (context, _) {
                      ...
                      return LocalShellSection(
                        ...
                        onOpenFiles: _openLocalFilesInstance,
                      );
                    },
                  ),
                ),
  ...
  Future<void> _openLocalFilesInstance(LocalShellInstance instance) async {
    if (!mounted) return;
    final localHost = widget.localShellController.localHost(instance);
    final localRepo = LocalShellSftpRepository(
      widget.localShellController,
      instance.id,
    );
    await Navigator.of(context).push(
      MaterialPageRoute<void>(
